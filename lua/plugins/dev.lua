...
return {
	...
	-- { import = "nvchad.blink.lazyspec" },
	{
		...
		opts = {
			keymap = {
				[require("configs.os-specializations").custom.completionOpen] = { "show" },
				["<ESC>"] = { "hide", "fallback" },
				["<CR>"] = { "accept", "fallback" },
...

	{
		...
		config = function()
			require("configs.dap")
			require("lib.lazy.deferred").notify_module("dap")
		end,
	},
	{
	...
	{
		enabled = require("configs.os-specializations").plugins.direnv.enable,
		"direnv/direnv.vim",
		lazy = false,
	},
	{
